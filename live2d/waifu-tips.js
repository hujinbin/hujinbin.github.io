...
live2d_settings['homePageUrl']          = 'https://hjb.leheavengame.com/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://hjb.leheavengame.com/about/';   // 关于页地址, '{URL 网址}'
